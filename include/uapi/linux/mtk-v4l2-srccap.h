...
#define V4L2_CID_ADC_AUTO_CALIBRATION_MODE		(SRCCAP_ADC_BASE + 7)
#define V4L2_CID_ADC_CENTER_GAIN			(SRCCAP_ADC_BASE + 8)
#define V4L2_CID_ADC_CENTER_OFFSET			(SRCCAP_ADC_BASE + 9)
#define V4L2_CID_ADC_YPBPR_FIXED_GAIN			(SRCCAP_ADC_BASE + 10)
#define V4L2_CID_ADC_YPBPR_FIXED_OFFSET			(SRCCAP_ADC_BASE + 11)
#define V4L2_CID_ADC_YPBPR_FIXED_PHASE			(SRCCAP_ADC_BASE + 12)
#define V4L2_CID_ADC_VGA_FIXED_GAIN			(SRCCAP_ADC_BASE + 13)
#define V4L2_CID_ADC_VGA_FIXED_OFFSET			(SRCCAP_ADC_BASE + 14)
#define V4L2_CID_ADC_VGA_FIXED_PHASE			(SRCCAP_ADC_BASE + 15)
...
#define V4L2_CID_AVD_VBI_CGMS_DETECT	(SRCCAP_AVD_BASE + 30)
#define V4L2_CID_AVD_AFEC_MACRO_VISION_DETECT	(SRCCAP_AVD_BASE + 31)
#define V4L2_CID_AVD_75IRE_SETUP_CANCEL	(SRCCAP_AVD_BASE + 32)
#define V4L2_CID_AVD_CROP_SCREEN_INFO	(SRCCAP_AVD_BASE + 33)
#define V4L2_CID_AVD_SNOW_FLOW	(SRCCAP_AVD_BASE + 34)

/* Common class control IDs */
#define V4L2_CID_COMMON_FORCE_VSYNC			(SRCCAP_COMMON_BASE + 0)
#define V4L2_CID_COMMON_DITHER				(SRCCAP_COMMON_BASE + 1)
#define V4L2_CID_COMMON_HDR_TYPE			(SRCCAP_COMMON_BASE + 2)
#define V4L2_CID_SRCCAP_PQMAP_INFO			(SRCCAP_COMMON_BASE + 3)
#define V4L2_CID_COMMON_PQMAP_RM_INFO			(SRCCAP_COMMON_BASE + 4)
...
#define V4L2_CID_HDMI_RX_GET_CLK_STATUS (SRCCAP_HDMIRX_BASE + 60)
#define V4L2_CID_HDMI_RX_SET_SCDCVAL (SRCCAP_HDMIRX_BASE + 61)
#define V4L2_CID_HDMI_RX_DDC_BUS_CONTROL (SRCCAP_HDMIRX_BASE + 62)
...
#define V4L2_CID_MEMOUT_PRE_CALCULATE_SIZE	(SRCCAP_MEMOUT_BASE + 4)
...
#define V4L2_EVENT_CTRL_CH_HDMI_RX_DE_UNSTABLE		 (V4L2_EVENT_CTRL_CH_HDMI_RX_BASE+7)
#define V4L2_EVENT_CTRL_CH_HDMI_RX_DE_STABLE		 (V4L2_EVENT_CTRL_CH_HDMI_RX_BASE+8)
#define V4L2_EVENT_CTRL_CH_HDMI_RX_HDMI_UNSTABLE		(V4L2_EVENT_CTRL_CH_HDMI_RX_BASE+9)
#define V4L2_EVENT_CTRL_CH_HDMI_RX_HDMI_STABLE		 (V4L2_EVENT_CTRL_CH_HDMI_RX_BASE+10)
#define V4L2_EVENT_CTRL_CH_HDMI_RX_HDMI_SIGNAL_LOST	(V4L2_EVENT_CTRL_CH_HDMI_RX_BASE+11)
...
#define V4L2_EVENT_SIGNAL_STATUS_CHANGE		(SRCCAP_EVENT_START | 0x10)
#define V4L2_EVENT_RESOLUTION_CHANGE		(SRCCAP_EVENT_START | 0x11)
#define V4L2_EVENT_FRAMERATE_CHANGE		(SRCCAP_EVENT_START | 0x12)
#define V4L2_EVENT_SCANTYPE_CHANGE		(SRCCAP_EVENT_START | 0x13)
#define V4L2_EVENT_COLORFORMAT_CHANGE		(SRCCAP_EVENT_START | 0x14)
#define V4L2_EVENT_DQBUF_CHANGE			(SRCCAP_EVENT_START | 0x15)

#define V4L2_EVENT_HDMI_SIGNAL_CHANGE		(SRCCAP_EVENT_START | 0x20)
#define V4L2_EVENT_HDMI2_SIGNAL_CHANGE		(SRCCAP_EVENT_START | 0x21)
#define V4L2_EVENT_HDMI3_SIGNAL_CHANGE		(SRCCAP_EVENT_START | 0x22)
#define V4L2_EVENT_HDMI4_SIGNAL_CHANGE		(SRCCAP_EVENT_START | 0x23)

#define V4L2_EVENT_CVBS_SIGNAL_CHANGE		(SRCCAP_EVENT_START | 0x30)
#define V4L2_EVENT_CVBS2_SIGNAL_CHANGE		(SRCCAP_EVENT_START | 0x31)
#define V4L2_EVENT_CVBS3_SIGNAL_CHANGE		(SRCCAP_EVENT_START | 0x32)
#define V4L2_EVENT_CVBS4_SIGNAL_CHANGE		(SRCCAP_EVENT_START | 0x33)
#define V4L2_EVENT_CVBS5_SIGNAL_CHANGE		(SRCCAP_EVENT_START | 0x34)
#define V4L2_EVENT_CVBS6_SIGNAL_CHANGE		(SRCCAP_EVENT_START | 0x35)
#define V4L2_EVENT_CVBS7_SIGNAL_CHANGE		(SRCCAP_EVENT_START | 0x36)
#define V4L2_EVENT_CVBS8_SIGNAL_CHANGE		(SRCCAP_EVENT_START | 0x37)

#define V4L2_EVENT_SVIDEO_SIGNAL_CHANGE		(SRCCAP_EVENT_START | 0x40)
#define V4L2_EVENT_SVIDEO2_SIGNAL_CHANGE	(SRCCAP_EVENT_START | 0x41)
#define V4L2_EVENT_SVIDEO3_SIGNAL_CHANGE	(SRCCAP_EVENT_START | 0x42)
#define V4L2_EVENT_SVIDEO4_SIGNAL_CHANGE	(SRCCAP_EVENT_START | 0x43)

#define V4L2_EVENT_YPBPR_SIGNAL_CHANGE		(SRCCAP_EVENT_START | 0x50)
#define V4L2_EVENT_YPBPR2_SIGNAL_CHANGE		(SRCCAP_EVENT_START | 0x51)
#define V4L2_EVENT_YPBPR3_SIGNAL_CHANGE		(SRCCAP_EVENT_START | 0x52)

#define V4L2_EVENT_VGA_SIGNAL_CHANGE		(SRCCAP_EVENT_START | 0x60)
#define V4L2_EVENT_VGA2_SIGNAL_CHANGE		(SRCCAP_EVENT_START | 0x61)
#define V4L2_EVENT_VGA3_SIGNAL_CHANGE		(SRCCAP_EVENT_START | 0x62)

#define V4L2_EVENT_SCART_SIGNAL_CHANGE		(SRCCAP_EVENT_START | 0x70)
#define V4L2_EVENT_SCART2_SIGNAL_CHANGE		(SRCCAP_EVENT_START | 0x71)

/* ADC events */

/* AVD events */
#define V4L2_SRCCAP_CTRL_AVD_MACROVISION_DETECT	(SRCCAP_AVD_EVENT_START | 0x1)
#define V4L2_SRCCAP_CTRL_AVD_CGMS_DETECT		(SRCCAP_AVD_EVENT_START | 0x2)
...
enum v4l2_ext_hdmi_event_id {
	...
	V4L2_SRCCAP_CTRL_EVENT_HDMIRX_DE_STATUS,
	V4L2_SRCCAP_CTRL_EVENT_HDMIRX_HDMI_STATUS,
	V4L2_SRCCAP_CTRL_EVENT_HDMIRX_HDMI_MAX,
};

#define V4L2_SRCCAP_HDMIRX_MONITOR_HDMIMODE			_BIT(0)
#define V4L2_SRCCAP_HDMIRX_MONITOR_DESTATUS			_BIT(1)
#define V4L2_SRCCAP_HDMIRX_MONITOR_HDMISTATUS		_BIT(2)
...
enum v4l2_ext_hdmi_colorimetry_format {
	V4L2_EXT_HDMI_COLORIMETRY_NO_DATA,
	V4L2_EXT_HDMI_COLORIMETRY_SMPTE_170M,
	V4L2_EXT_HDMI_COLORIMETRY_ITU_R_BT_709,
	V4L2_EXT_HDMI_COLORIMETRY_DEFAULT = V4L2_EXT_HDMI_COLORIMETRY_NO_DATA,
	V4L2_EXT_HDMI_COLORIMETRY_UNKNOWN = 3,    ///< Unknown
};
...
enum v4l2_ext_hdmi_ext_colorimetry_format {
	...
	V4L2_EXT_HDMI_EXT_COLOR_SYCC601,		 ///< sYCC 601
...
enum v4l2_ext_hdmi_ar_type {
	...
	V4L2_EXT_HDMI_AF_AR_16x9_C = 0x0A,
...
enum v4l2_ext_hdmi_get_data_info {
	...
	V4L2_EXT_HDMI_GET_H_POLARITY,
	V4L2_EXT_HDMI_GET_V_POLARITY,
	V4L2_EXT_HDMI_GET_INTERLACE,
	V4L2_EXT_HDMI_GET_CHIP_HDCP_CAPABILITY,
	V4L2_EXT_HDMI_GET_VFRONT,
	V4L2_EXT_HDMI_GET_VSYNC,
	V4L2_EXT_HDMI_GET_VBACK,
	V4L2_EXT_HDMI_GET_HFRONT,
	V4L2_EXT_HDMI_GET_HSYNC,
	V4L2_EXT_HDMI_GET_HBACK,
	V4L2_EXT_HDMI_GET_PIXEL_CLOCK,
	V4L2_EXT_HDMI_GET_FS,  // audio?
	V4L2_EXT_HDMI_GET_AUD_N,
	V4L2_EXT_HDMI_GET_AUD_CTS,
	V4L2_EXT_HDMI_GET_AUD_STATUS,
	V4L2_EXT_HDMI_GET_FRAMERATE,
	V4L2_EXT_HDMI_GET_CLOCKSTABLE_STATUS,
	V4L2_EXT_HDMI_GET_PIPELINE_MODE,
	V4L2_EXT_HDMI_GET_EMP_ENABLE_STATUS,
	// Polarity Ret -> P:0, N:1
	V4L2_EXT_HDMI_GET_H_POLARITY_BY_SRC,  // bef regen
	V4L2_EXT_HDMI_GET_V_POLARITY_BY_SRC,  // bef regen
	V4L2_EXT_HDMI_GET_HDE_DEC,  // bef regen
	V4L2_EXT_HDMI_GET_VDE_DEC,  // bef regen
};
...
enum v4l2_ext_avd_factory_mode {
	V4L2_EXT_AVD_FACTORY_MODE_SET_VALUE = 0,
	V4L2_EXT_AVD_FACTORY_MODE_SET_PARA,
	V4L2_EXT_AVD_FACTORY_MODE_MAX
};
...
enum v4l2_adc_auto_calibration_mode {
	V4L2_ADC_HW_CALIBRATION,
	V4L2_ADC_SW_CALIBRATION,
};

enum v4l2_adc_auto_tune_type {
	V4L2_ADC_AUTO_TUNE_NULL,
	// Auto-tune RGB Color
	V4L2_ADC_AUTO_TUNE_RGB_COLOR,
	// Auto-tune YUV Color
	V4L2_ADC_AUTO_TUNE_YUV_COLOR,
};

enum v4l2_common_hdr_type {
	V4L2_COMMON_HDR_NONE = 0,
	V4L2_COMMON_HDR_DOLBY,
	V4L2_COMMON_HDR_HDR10,
	V4L2_COMMON_HDR_HDR10PLUS,
	V4L2_COMMON_HDR_HLG10,
	V4L2_COMMON_HDR_PQ10,
	V4L2_COMMON_HDR_TCH,
	V4L2_COMMON_HDR_VIVID,
};
...
enum v4l2_timingdetect_status {
	...
	V4L2_TIMINGDETECT_NO_SIGNAL_SCANNING,
	V4L2_TIMINGDETECT_UNSTABLE_SCANNING,
};
...
struct v4l2_ext_hdmi_dsc_info {
	...
	__u16 u8_linebuf_depth; // pps3[3:0]
	__u8 u8_convert_rgb; // pps4[4]
...
struct v4l2_ext_hdmi_set_scdc_value {
	// port Index v4l2_srccap_input_source
	enum v4l2_srccap_input_source enInputPortType;
	// SCDC offset
	__u8 ucOffset;
...
struct v4l2_ext_hdmi_ddc_ctrl {
	// port index from v4l2_srccap_input_source
	enum v4l2_srccap_input_source enInputPortType;
	// DDC enable or disable
	bool bEnable;
} __attribute__((packed));
...
struct v4l2_ext_avd_factory_data {
	enum v4l2_ext_avd_factory_mode eFactoryOperate;
...
struct v4l2_ext_avd_crop_screen_info {
	__u32 cropScreen_x;
	__u32 cropScreen_y;
	__u32 cropScreen_width;
	__u32 cropScreen_height;
} __attribute__((__packed__));
...
struct v4l2_common_pqmap_rm_info {
	union {
		__u64 addr;
		__u16 *node_array;
	} p;
...
struct v4l2_memout_pre_calu_size {
	__u32   width;
	__u32   height;
	__u32   color_fmt;
	__u32   calu_size; //for get ctrl
	bool   interlaced;
} __attribute__((packed));
