...
#define DMX2_CAPS_PVR_NUMBER		"pvr_numb"
#define DMX2_CAPS_STC_NUMBER		"stc_numb"
#define DMX2_CAPS_CILINK_NUMBER		"cilink_numb"
#define DMX2_CAPS_TSO_NUMBER		"tso_numb"
...
#define DMX2_CODEC_VIDEO_AVS	dmx2_fourcc('A', 'V', 'S', '0') /* AVS	*/
#define DMX2_CODEC_VIDEO_AVS2	dmx2_fourcc('A', 'V', 'S', '2') /* AVS2 */
#define DMX2_CODEC_VIDEO_AVS3	dmx2_fourcc('A', 'V', 'S', '3') /* AVS3 */
...
struct dmx2_mmtp_metadata {
	__u32 itemId;
	__u32 mpuSequenceNumber;
	__u32 itemFragmentIndex;
	__u32 lastItemFragmentIndex;
	__u32 dataLength;
};
...
/* Get: int32 */
#define DMX2_CID_GET_FIFO_ID			(DMX2_CID_MTK_BASE+10)

/* Get: int32 */
#define DMX2_CID_GET_STC_ID			(DMX2_CID_MTK_BASE+11)

/* Get: uint32 */
#define DMX2_CID_GET_REMAINING_SIZE		(DMX2_CID_MTK_BASE+12)

/* Set: Set Pid need to be lock by DMX TA pipeline Id*/
#define DMX2_CID_SET_PID_SECURE			(DMX2_CID_MTK_BASE+13)

/* Set: uint32 */
#define DMX2_CID_RECORD_PAUSE			(DMX2_CID_MTK_BASE+14)

/* Get: uint32 */
#define DMX2_CID_GET_DMABUF_DATA		(DMX2_CID_MTK_BASE+15)

#define DMX2_CID_QBUF_DMA				(DMX2_CID_MTK_BASE+16)

#define DMX2_CID_DQBUF_DMA			(DMX2_CID_MTK_BASE+17)


/* Stc device IO */
#define DMX2_STC_ENGINE_GET_ID			_IOR('o', 129, __u32)
#define DMX2_STC_ENGINE_GET_VALUE		_IOR('o', 130, struct dmx2_stc)
#define DMX2_STC_ENGINE_SET_VALUE		_IOW('o', 131, struct dmx2_stc)
#define DMX2_STC_ENGINE_SET_RATE		_IOW('o', 132, __u32)
#define DMX2_STC_ENGINE_SET_MODE		_IOW('o', 133, __u32)
