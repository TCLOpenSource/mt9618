...
#define CA_DISCONNECT_KEYTOKEN          _IOW('o', 126, unsigned int)

#define CA_TEST_ALLOCATE_KEYTOKEN       _IOWR('o', 150, unsigned long long)
#define CA_TEST_FREE_KEYTOKEN           _IOW('o', 151, unsigned long long)
