...
/* m_vdec.h */
#ifndef E_COMPONENT9_TAG_START
#define E_COMPONENT9_TAG_START 0x00090000
enum EN_COMPONENT9_TAG { /* range 0x00090000 ~ 0x0009FFFF */
	MTK_VDEC_DD_FRM_INFO_TAG = E_COMPONENT9_TAG_START,
	MTK_VDEC_DD_COMPRESS_INFO_TAG,
	MTK_VDEC_DD_COLOR_DESC_TAG,
	MTK_VDEC_DD_FRM_STATISTIC_TAG,
	MTK_VDEC_DD_CLOSED_CAPTION_TAG,
	MTK_VDEC_DD_SVP_INFO_TAG,
	MTK_VDEC_DD_HDR10PLUS_DESC_TAG,
	MTK_VDEC_DD_FB_HW_CRC_TAG,
	MTK_VDEC_DD_DOLBY_DESC_TAG,
	MTK_VDEC_DD_FG_DESC_TAG,
	MTK_VDEC_DD_CUVAHDR_DESC_TAG,
	MTK_VDEC_DD_SLHDR_DESC_TAG,
	MTK_VDEC_DD_DV_PARSING_TAG,
	E_COMPONENT9_TAG_MAX,
};
#endif
...
struct vdec_dd_color_desc {
	...
	__u8 hdr_type;  /* enum HDR_TYPE_E, align with mi_vdec MI_VDEC_HdrType_e*/
	__u8 colour_description_present_flag;
};
...
#define MTK_VDEC_DV_PARSING_VERSION (0)
