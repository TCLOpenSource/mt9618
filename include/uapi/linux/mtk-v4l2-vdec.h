...
enum v4l2_vdec_fmt_modifier_vsd {
	V4L2_VDEC_VSD_NONE = 0,
	V4L2_VDEC_VSD_8x2 = 1,
	V4L2_VDEC_VSD_8x4 = 2,
};

enum v4l2_vdec_tee_type {
	V4L2_VDEC_NONE_TEE = 0,
	V4L2_VDEC_TRUSTONIC_TEE = 1,
	V4L2_VDEC_INHOUSE_TEE = 2,
	V4L2_VDEC_BLOWFISH_TEE = 3,
	V4L2_VDEC_MICROTRUST_TEE = 4,
	V4L2_VDEC_OPEN_TEE = 5, /* temp only use this one for tv*/
};
...
struct v4l2_vdec_color_desc {
	...
	__u32 hdr_type;  /* enum HDR_TYPE_E, align with mi_vdec MI_VDEC_HdrType_e*/
} __attribute__((packed));
...
/* struct v4l2_vdec_bandwidth_info */
#define V4L2_CID_VDEC_MAX_BUF_INFO (V4L2_CID_VDEC_BASE + 22) /* [set][get] */
/* v4l2_vdec_max_buf_info */
#define V4L2_CID_VDEC_DISABLE_DEBLOCK (V4L2_CID_VDEC_BASE + 24)
/* enum v4l2_vdec_disable_deblock [set] */
