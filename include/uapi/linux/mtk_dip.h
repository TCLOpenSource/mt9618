...
#define V4L2_CID_EXT_DIP_FLOWCONTROL   (V4L2_CID_EXT_DIP_OUTPUT_INFO+1)
#define V4L2_CID_EXT_DIP_PQBW_INFO     (V4L2_CID_EXT_DIP_FLOWCONTROL+1)
#define V4L2_CID_EXT_DIP_HIGHWAY_LR_CTRL     (V4L2_CID_EXT_DIP_PQBW_INFO+1)
#define V4L2_CID_EXT_DIP_SET_DISP_INFO     (V4L2_CID_EXT_DIP_HIGHWAY_LR_CTRL+1)
#define V4L2_CID_EXT_DIP_SET_1RNW      (V4L2_CID_EXT_DIP_SET_DISP_INFO+1)
...
/* 32bit, MSB->A(2)->B(10)->G(10)->R(10)->LSB */
#define V4L2_PIX_FMT_DIP_ABGR2101010  v4l2_fourcc('M', 'B', '2', '1')
...
/* MTK DIPR VSD8x4, two contiguous planes */
#define V4L2_PIX_FMT_CODEC_VSD8X4      v4l2_fourcc('C', 'V', '8', '4')
/* MTK DIPR VSD8x2, two contiguous planes */
#define V4L2_PIX_FMT_CODEC_VSD8X2      v4l2_fourcc('C', 'V', '8', '2')
/* 12  Y/Cb/Cr 4:2:0, 3 plane*/
#define V4L2_PIX_FMT_YV12             v4l2_fourcc('Y', 'V', '1', '2')

/* MTK DIP YC422 Rotate */
#define V4L2_PIX_FMT_DIP_YUYV_ROT	v4l2_fourcc('M', 'R', 'O', 'T')
...
typedef enum {
	...
	E_DIP_SOURCE_B2R,
	E_DIP_SOURCE_STREAM_ALL_VIDEO_OSDB0,
	E_DIP_SOURCE_GOP0,
	E_DIP_SOURCE_B2R_MAIN,
...
typedef enum {
	...
	E_DIP_CAP_IN_HEIGHT_ALIGN,
	E_DIP_CAP_OUT_HEIGHT_ALIGN,
	E_DIP_CAP_HVSP_RATIO_MAX,
...
struct ST_DIP_SOURCE_INFO {
	...
	__u32 u32Fps;
	enum EN_CLR_RANGE enClrRange;
	__u8 u8ClrColorSpace;
	__u8 u8ClrTransferCharacter;
	__u8 u8ClrMatrixCoef;
};
...
struct ST_DIP_FLOW_CONTROL {
	__u8 u8Enable;
	__u64 u64BytePerSec;
};

struct ST_DIP_PQBW_INFOL {
	__u32 u32PqWinTime;
	__u64 u64PqRemainderBudget;
};
...
struct ST_DIP_HIGHWAY_LR_CTRL {
	__u8 u8HighwayEn;
	EN_DIP_LR_MODE enLRMode;
};

typedef enum  {
	E_DIP_COLOR_SPACE_BT601,
	E_DIP_COLOR_SPACE_BT709,
	E_DIP_COLOR_SPACE_BT2020,
	E_DIP_COLOR_COLOR_SPACE_RESERVED,
} EN_DIP_COLOR_SPACE;

typedef enum  {
	E_DIP_COLOR_RANGE_LIMIT,
	E_DIP_COLOR_RANGE_FULL,
	E_DIP_COLOR_RANGE_RESERVED,
} EN_DIP_COLOR_RANGE;

struct ST_DIP_BLENDING_DISP_INFO {
	__u16 u16DispX;
	__u16 u16DispY;
	__u16 u16Background_A;
	__u16 u16Background_R;
	__u16 u16Background_G;
	__u16 u16Background_B;
	EN_CLR_FMT enDstClrFmt;
	EN_DIP_COLOR_RANGE enDstClrRange;
	EN_DIP_COLOR_SPACE enDstClrSpace;
};
