...
#define V4L2_HISTOGRAM_BIN_NUM_MAX      (128)    // align with PQU_HISTOGRAM_BIN_NUM_MAX
...
#define EV_DATA_INVALID_FRMAE 1
...
// Dolby Vision config
#define V4L2_DV_MAX_MODE_NUM	        (64)
#define V4L2_DV_MAX_MODE_LENGTH         (64)
#define V4L2_DV_MAX_GD_TABLE_POINT_SIZE	(7)
...
//XC
#define V4L2_CALMAN_ARRAY_SIZE          (2)
/************************************************
 *******************CTRL CIDs*********************
 ************************************************
 */
...
// BASE
#define PQ_BASE                                 (V4L2_CID_USER_BASE + 0x2000)

//COMMON
#define V4L2_CID_INPUT_EXT_INFO                 (PQ_BASE + 0x1)
//fixme remove
#define V4L2_CID_OUTPUT_EXT_INFO                (PQ_BASE + 0x2)
//fixme remove
#define V4L2_CID_FORCE_P_MODE                   (PQ_BASE + 0x3)
#define V4L2_CID_DELAY_TIME                     (PQ_BASE + 0x4)
#define V4L2_CID_INPUT_TIMING                   (PQ_BASE + 0x5)
#define V4L2_CID_GEN_PATTERN                    (PQ_BASE + 0x6)
#define V4L2_CID_SET_PATH                       (PQ_BASE + 0x7)
#define V4L2_CID_CFD_SET_CURVE                  (PQ_BASE + 0x8)
#define V4L2_CID_CFD_GET_CURVE                  (PQ_BASE + 0x9)
#define V4L2_CID_SET_PATTERN_INFO               (PQ_BASE + 0xa)
#define V4L2_CID_SET_PANEL_COLOR_INFO           (PQ_BASE + 0xb)

//pq-enhance:HDR base:0x100
#define V4L2_CID_HDR_BASE                       (PQ_BASE + 0x100)
#define V4L2_CID_DOLBY_3DLUT                    (PQ_BASE + 0x101)
#define V4L2_CID_DOLBY_HDR_MODE                 (PQ_BASE + 0x102)
#define V4L2_CID_CUS_COLOR_RANGE                (PQ_BASE + 0x103)
#define V4L2_CID_HDR_ENABLE_MODE                (PQ_BASE + 0x104)
#define V4L2_CID_TMO_MODE                       (PQ_BASE + 0x105)
#define V4L2_CID_CFD_CUSTOMER_SETTING           (PQ_BASE + 0x106)
#define V4L2_CID_HDR_ATTR                       (PQ_BASE + 0x107)
#define V4L2_CID_HDR_SEAMLESS_STATUS            (PQ_BASE + 0x108)
#define V4L2_CID_HDR_TYPE                       (PQ_BASE + 0x109)
#define V4L2_CID_HDR_CUS_COLORI_METRY           (PQ_BASE + 0x10a)
#define V4L2_CID_HDR_DOLBY_GD_INFO              (PQ_BASE + 0x10b)
#define V4L2_CID_DOLBY_BIN_DATA                 (PQ_BASE + 0x10c)
#define V4L2_CID_DOLBY_BIN_BUFFER               (PQ_BASE + 0x10d)
#define V4L2_CID_DOLBY_LS_DATA                  (PQ_BASE + 0x10e)
#define V4L2_CID_DOLBY_PD_MODE                  (PQ_BASE + 0x10f)

//pq-enhance:PQD base:0x200
#define V4L2_CID_PQ_BASE                        (PQ_BASE + 0x200)
#define V4L2_CID_PQ_DBGLEVEL                    (PQ_BASE + 0x201)
#define V4L2_CID_PQ_INIT                        (PQ_BASE + 0x202)
#define V4L2_CID_PQ_SETTING                     (PQ_BASE + 0x203)
#define V4L2_CID_MADI_MOTION                    (PQ_BASE + 0x204)
#define V4L2_CID_RFBL_MODE                      (PQ_BASE + 0x205)
#define V4L2_CID_DOT_BY_DOT                     (PQ_BASE + 0x206)
#define V4L2_CID_PQ_TABLE_STATUS                (PQ_BASE + 0x207)
#define V4L2_CID_UCD_MODE                       (PQ_BASE + 0x208)
#define V4L2_CID_HSB_BYPASS                     (PQ_BASE + 0x209)
#define V4L2_CID_PICTUREMODE                    (PQ_BASE + 0x20a)
#define V4L2_CID_LOAD_PTP                       (PQ_BASE + 0x20b)
#define V4L2_CID_NR_SETTINGS                    (PQ_BASE + 0x20c)
#define V4L2_CID_DPU_MODULE_SETTINGS            (PQ_BASE + 0x20d)
#define V4L2_CID_CCM                            (PQ_BASE + 0x20e)
#define V4L2_CID_COLOR_TUNER                    (PQ_BASE + 0x20f)
#define V4L2_CID_HSY                            (PQ_BASE + 0x210)
#define V4L2_CID_MANUAL_LUMA_CURVE              (PQ_BASE + 0x211)
#define V4L2_CID_BLACK_WHITE_STRETCH            (PQ_BASE + 0x212)
#define V4L2_CID_PQ_CMD                         (PQ_BASE + 0x213)
#define V4L2_CID_COLORTEMP                      (PQ_BASE + 0x214)
#define V4L2_CID_3D_CLONE_PQMAP                 (PQ_BASE + 0x215)
#define V4L2_CID_SWDR_INFO                      (PQ_BASE + 0x216)
#define V4L2_CID_DUAL_VIEW_STATUS               (PQ_BASE + 0x217)
#define V4L2_CID_RGB_PATTERN                    (PQ_BASE + 0x218)
#define V4L2_CID_BLUE_STRETCH                   (PQ_BASE + 0x219)
#define V4L2_CID_H_NONLINEARSCALING             (PQ_BASE + 0x21a)
#define V4L2_CID_MCDI_MODE                      (PQ_BASE + 0x21b)
#define V4L2_CID_DEALYTIME                      (PQ_BASE + 0x21c)
#define V4L2_CID_PQ_CAPS                        (PQ_BASE + 0x21d)
#define V4L2_CID_PQ_VERSION                     (PQ_BASE + 0x21e)
#define V4L2_CID_ZERO_FRAME_MODE                (PQ_BASE + 0x21f)
#define V4L2_CID_EVALUATE_FBL                   (PQ_BASE + 0x220)
#define V4L2_CID_HISTOGRAM                      (PQ_BASE + 0x221)
#define V4L2_CID_HSY_RANGE                      (PQ_BASE + 0x222)
#define V4L2_CID_LUMA_CURVE                     (PQ_BASE + 0x223)
#define V4L2_CID_CHROMA                         (PQ_BASE + 0x224)
#define V4L2_CID_3D_CLONE_PIP                   (PQ_BASE + 0x225)
#define V4L2_CID_3D_CLONE_LBL                   (PQ_BASE + 0x226)
#define V4L2_CID_GAME_MODE                      (PQ_BASE + 0x227)
#define V4L2_CID_BOB_MODE                       (PQ_BASE + 0x228)
#define V4L2_CID_BYPASS_MODE                    (PQ_BASE + 0x229)
#define V4L2_CID_DMEO_CLONE                     (PQ_BASE + 0x22a)
#define V4L2_CID_REDUCE_BW                      (PQ_BASE + 0x22b)
#define V4L2_CID_HDR_LEVEL                      (PQ_BASE + 0x22c)
#define V4L2_CID_MWE                            (PQ_BASE + 0x22d)
#define V4L2_CID_PQ_EXIT                        (PQ_BASE + 0x22e)
#define V4L2_CID_RB_CHANNEL                     (PQ_BASE + 0x22f)
#define V4L2_CID_FILM_MODE                      (PQ_BASE + 0x230)
#define V4L2_CID_NR_MODE                        (PQ_BASE + 0x231)
#define V4L2_CID_MEPG_NR_MODE                   (PQ_BASE + 0x232)
#define V4L2_CID_XVYCC_MODE                     (PQ_BASE + 0x233)
#define V4L2_CID_DLC_MODE                       (PQ_BASE + 0x234)
#define V4L2_CID_SWDR_MODE                      (PQ_BASE + 0x235)
#define V4L2_CID_DYNAMIC_CONTRAST_ENABLE        (PQ_BASE + 0x236)
#define V4L2_CID_PQ_GAMMA                       (PQ_BASE + 0x237)
#define V4L2_CID_DLC_INIT                       (PQ_BASE + 0x238)
#define V4L2_CID_DLC_HISTO_RANGE                (PQ_BASE + 0x239)
#define V4L2_CID_PQMAP_INFO                     (PQ_BASE + 0x23a)
#define V4L2_CID_PQ_METADATA                    (PQ_BASE + 0x23b)
#define V4L2_CID_PQPARAM                        (PQ_BASE + 0x23c)
#define V4L2_CID_SET_PQ_MEMORY_INDEX            (PQ_BASE + 0x23d)
#define V4L2_CID_DIPMAP_INFO                    (PQ_BASE + 0x23e)

//3D base:0x300
#define V4L2_CID_3D_BASE                        (PQ_BASE + 0x300)
#define V4L2_CID_3D_HW_VERSION                  (PQ_BASE + 0x301)
#define V4L2_CID_3D_LR_FRAME_EXCHG              (PQ_BASE + 0x302)
#define V4L2_CID_3D_FORMAT                      (PQ_BASE + 0x303)
#define V4L2_CID_3D_HSHIFT                      (PQ_BASE + 0x304)
#define V4L2_CID_3D_MODE                        (PQ_BASE + 0x305)

//DISPLAY base:0x400
#define V4L2_CID_DISPLAY_BASE                   (PQ_BASE + 0x400)
#define V4L2_CID_SET_DISPLAY_DATA               (PQ_BASE + 0x401)
#define V4L2_CID_GET_DISPLAY_DATA               (PQ_BASE + 0x402)
#define V4L2_CID_GET_QUEUE_INFO                 (PQ_BASE + 0x404)
#define V4L2_CID_SET_STREAMMETA_DATA            (PQ_BASE + 0x405)
#define V4L2_CID_SET_INPUT_MODE                 (PQ_BASE + 0x406)
#define V4L2_CID_SET_OUTPUT_MODE                (PQ_BASE + 0x407)
#define V4L2_CID_GET_RW_DIFF                    (PQ_BASE + 0x408)
#define V4L2_CID_SET_FLOW_CONTROL               (PQ_BASE + 0x409)
#define V4L2_CID_SET_AISR_ACTIVE_WIN            (PQ_BASE + 0x40a)
#define V4L2_CID_STREAM_DEBUG                   (PQ_BASE + 0x40b)
#define V4L2_CID_SET_STAGE_PATTERN              (PQ_BASE + 0x40c)
#define V4L2_CID_GET_EXTRA_FRAME                (PQ_BASE + 0x40d)
#define V4L2_CID_GET_PQ_BUF_ALLOC               (PQ_BASE + 0x40e)
#define V4L2_CID_SET_OUTPUT_BUF                 (PQ_BASE + 0x40f)

//B2R base:0x500
#define V4L2_CID_B2R_BASE                       (PQ_BASE + 0x500)
#define V4L2_CID_B2R_TIMING                     (PQ_BASE + 0x501)
#define V4L2_CID_B2R_GLOBAL_TIMING              (PQ_BASE + 0x502)
#define V4L2_CID_B2R_GET_CAP                    (PQ_BASE + 0x503)
#define V4L2_CID_B2R_GET_MAX_FPS                (PQ_BASE + 0x504)
#define V4L2_CID_B2R_GET_RB_SWAP                (PQ_BASE + 0x505)

//XC base:0x600
#define V4L2_CID_PQ_BUFFER_REQ                  (PQ_BASE + 0x612)
#define V4L2_CID_PQ_SECURE_MODE                 (PQ_BASE + 0x613)
#define V4L2_CID_PQ_TRY_QUEUE                   (PQ_BASE + 0x614)
#define V4L2_CID_PQ_S_BUFFER_INFO               (PQ_BASE + 0x615)
#define V4L2_CID_PQ_G_BUFFER_OUT_INFO           (PQ_BASE + 0x616)
#define V4L2_CID_PQ_G_BUFFER_CAP_INFO           (PQ_BASE + 0x617)
...
#define V4L2_EVENT_MTK_PQ_RE_QUEUE_TRIGGER    (V4L2_EVENT_PRIVATE_START | 0x16)
#define V4L2_EVENT_MTK_PQ_BBD_TRIGGER    (V4L2_EVENT_PRIVATE_START | 0x17)
#define V4L2_EVENT_MTK_PQ_DOVI_FRAME_META     (V4L2_EVENT_PRIVATE_START | 0x18)
...
enum mtk_pq_display_ctrl_type {
	...
	MTK_PQ_DISPLAY_CTRL_TYPE_HWMAP_SWBIT,
...
// align with m_pq_histogram_type
enum v4l2_pq_histogram_type {
	V4L2_PQ_E_HISTOGRAM_BIN_NUM_RANGE = 0,
	V4L2_PQ_E_HISTOGRAM_HUE_IP        = 1,
	V4L2_PQ_E_HISTOGRAM_SATURATION_IP = 2,
	V4L2_PQ_E_HISTOGRAM_LUMA_IP       = 3,
	V4L2_PQ_E_HISTOGRAM_LUMA_EXT_IP   = 4,
	V4L2_PQ_E_HISTOGRAM_LUMA_AVG_IP   = 5,
	V4L2_PQ_E_HISTOGRAM_YLITE_IP      = 6,
	V4L2_PQ_E_HISTOGRAM_YLITE_EXT_IP  = 7,
	V4L2_PQ_E_HISTOGRAM_MAX           = 8,
};
...
struct v4l2_pq_panel_color_info {
	__u16 pnl_color_info_version;
	__u16 pnl_color_info_length;
	__u8  pnl_color_info_format;
	__u16 pnl_color_info_rx;
	__u16 pnl_color_info_ry;
	__u16 pnl_color_info_gx;
	__u16 pnl_color_info_gy;
	__u16 pnl_color_info_bx;
	__u16 pnl_color_info_by;
	__u16 pnl_color_info_wx;
	__u16 pnl_color_info_wy;
	__u16 pnl_color_info_maxlum;
	__u16 pnl_color_info_medlum;
	__u16 pnl_color_info_minlum;
	__u8  pnl_color_info_linear_rgb;
	__u16 pnl_color_info_hdrnits;
};

struct v4l2_pq_pattern_info_set {
	bool debug_mode;
	bool force_rgb;
	__u8 position;
	__u16 pattern_type;
	...
	bool enable_ts;
	bool enable;
	bool force_timing_enable;
	__u16 force_h_size;
	__u16 force_v_size;
	__u16 pure_color_red;
	__u16 pure_color_green;
	__u16 pure_color_blue;
};

/* flags for Calman */
struct v4l2_pq_cfd_curve_set {
	__u32 command_id;
	__u32 data_struct_size;
	__u32 data[V4L2_CALMAN_ARRAY_SIZE];
};

struct v4l2_pq_cfd_curve_get {
	__u8 u8WinID;
	__u32 u32CurveId; // m_pq_cfd_curve_state_name
	__u8 u8Data[29478];
};
...
struct mtk_pq_frame_info {
	...
	__u8 u8AspectRate;//frame_info[u16CurrentWritePointer].u8AspectRate
	__u8 u8Interlace;
	...
	struct mtk_pq_film_grain_desc vdec_filmgrain;
	struct mtk_pq_frm_statistic vdec_frmstatistic;
	struct v4l2_pq_buf buf;	//frame fd & metadata fd
} __attribute__((__packed__));

struct mtk_pq_hwmap_swbit {
	__u8 scmi_format;
	__u8 scmi_frame;
	__u8 scmi_delay;
	__u8 ucm_format;
...
struct mtk_pq_display_g_data {
	union {
		...
		struct mtk_pq_hwmap_swbit swbit;
	} data;
} __attribute__((__packed__));
...
struct v4l2_timing {
	...
	__u32 pixelformat; /*fourcc in videodev2.h*/
};
...
/* refer to enum en_dv_support_capability & MI_DISP_DV_SupportCapability_e */
enum v4l2_PQ_dv_support_capability {
	V4L2_PQ_DV_CAPABILITY_NONE			= 0,
	V4L2_PQ_DV_CAPABILITY_DOLBY_VISION_SUPPORT	= 0x1,
	V4L2_PQ_DV_CAPABILITY_DOLBY_PR_SUPPORT		= 0x2,
	V4L2_PQ_DV_CAPABILITY_DOLBY_IQ_SUPPORT		= 0x4,
	V4L2_PQ_DV_CAPABILITY_DOLBY_EUC_SUPPORT		= 0x8,
	V4L2_PQ_DV_CAPABILITY_DOLBY_APO_SUPPORT		= 0x10,
	V4L2_PQ_DV_CAPABILITY_DOLBY_LS_SUPPORT		= 0x20,

	V4L2_PQ_DV_CAPABILITY_MAX
};

/* refer to struct st_dv_config_capability_info & MI_DISP_DV_ConfigCapabilityInfo_t */
struct v4l2_PQ_dv_config_capability_info {
	__u32 en;
	__u32 capability;	// enum v4l2_PQ_dv_support_capability
};

/* refer to st_dv_config_control_info & MI_DISP_DV_ConfigControlInfo_t */
struct v4l2_PQ_dv_config_control_info {
	__u8 disable_dv;
};

/* refer to struct dv_gd_info & meta_pq_dv_gd_info & MI_DISP_dv_gd_info */
struct v4l2_dv_gd_info {
	bool valid;
	uint16_t gd;
	uint16_t delay;
	bool gd_gray_out;
...
/* refer to struct m_pq_dv_l11_info & meta_pq_dv_l11_info & MI_DISP_dv_l11_info */
struct v4l2_dv_l11_info {
	uint8_t u8l11Avail;
	uint8_t u8WPValid;
	...
	/** For VTS stub mode test 0:disable,1:enable */
	uint8_t u8Stub;
};
...
struct v4l2_dv_out_frame_info {
	bool stub;
	struct v4l2_dv_gd_info gd_info;
	__u32 dv_pq_hw_ver;
	struct v4l2_dv_l11_info l_11_Data;
	__u32 ret;
	__u8 u8PictureMode;
...
#define V4L2_DV_MAX_DBG_SYSFS_CTRL_SIZE		(128)
#define V4L2_DV_MAX_PQU_REPORT_SIZE		(512)
#define V4L2_DV_MAX_CORE_REPORT_SIZE		(256)
#define V4L2_DV_MAX_MIPQ_REPORT_SIZE		(512)
#define V4L2_DV_MAX_DOLBY_CFG_PATH_LENGTH	(96)
#define V4L2_DV_MAX_USER_CFG_PATH_LENGTH	(96)
#define V4L2_DV_MAX_CUST_CFG_PATH_LENGTH	(96)
#define V4L2_DV_MAX_UI_RULE_LENGTH		(96)

/* refer to mtk-v4l2-pq.h :   v4l2_PQ_dv_mi_pq_report */
struct v4l2_PQ_dv_mi_pq_report {
	__u8 report_enable;
	/* dolby config */
	__u8 path_dolby_cfg[V4L2_DV_MAX_DOLBY_CFG_PATH_LENGTH];
	__u8 path_user_cfg[V4L2_DV_MAX_USER_CFG_PATH_LENGTH];
	__u8 path_cust_cfg[V4L2_DV_MAX_CUST_CFG_PATH_LENGTH];
	/* capability */
	__u8 cap_dv;
	__u8 cap_iq;
	__u8 cap_apo;
	...
	__u8 ui_apo;
	__u8 ui_ls;
	__u8 ui_rule_str[V4L2_DV_MAX_UI_RULE_LENGTH];
};
...
struct v4l2_dv_gd_tbl_info {
	__u8 u8CurveXNum;
	__u8 u8CurveYNum;
	__u32 u32PWMCurveX[V4L2_DV_MAX_GD_TABLE_POINT_SIZE];
	__u32 u32PWMCurveY[V4L2_DV_MAX_GD_TABLE_POINT_SIZE];
};

/* refer to dv_core_if.h  :  st_dv_config_info            */
/*          mi_dev_disp.h :  MI_DEV_DISP_dv_config_info_t */
/*          mi_disp.h     :  MI_DISP_dv_config_info_t     */
/*          mtk-v4l2-pq.h :  v4l2_PQ_dv_config_info_t     */
typedef struct v4l2_PQ_dv_config_info_s {
	v4l2_PQ_dv_config_bin_info_t bin_info;
	v4l2_PQ_dv_config_mode_info_t mode_info;
	struct v4l2_PQ_dv_config_capability_info cap_info;
	struct v4l2_PQ_dv_config_control_info ctrl_info;
	struct v4l2_dv_out_frame_info out_frame_info;
	struct v4l2_dv_in_frame_info in_frame_info;
	/* debuggability */
	__u8 sysfs_ctrl[V4L2_DV_MAX_DBG_SYSFS_CTRL_SIZE];  // struct m_pq_dv_sysfs_control
	__u8 dovi_pqu_report[V4L2_DV_MAX_PQU_REPORT_SIZE]; // struct m_pq_dv_pqu_status_report
	__u8 dv_core_report[V4L2_DV_MAX_CORE_REPORT_SIZE]; // struct m_pq_dv_core_status_report
	__u8 dv_mipq_report[V4L2_DV_MAX_MIPQ_REPORT_SIZE]; // struct v4l2_PQ_dv_mi_pq_report
	struct v4l2_dv_gd_tbl_info dv_gd_tbl_info;
...
/*---------------- HISTOGRAM ---------------*/
struct v4l2_pq_histogram_bin_num {
	__u32 u32HueBinNum;
	__u32 u32LumaBinNum;
	__u32 u32LumaExtBinNum;
	__u32 u32SatBinNum;
	__u32 u32YLiteBinNum;
	__u32 u32YLiteExtBinNum;
};

// align with struct ST_PQ_YHSL_GETHUERPT_STATUS
struct v4l2_pq_yhsl_get_hue_rpt_status {
	__u32 u32Version;
	__u32 u32Length;
	// __u32 *pu32HueHist; // removed pointer for unaligned sizeof behavior
	__u32 u32Noncolor;
};

// align with ST_PQ_YHSL_GETSATRPT_STATUS
struct v4l2_pq_yhsl_get_sat_rpt_status {
	__u32  u32Version;
	__u32  u32Length;
	__u64  u64TotalPixelSatWeight;
	__u32  u32TotalPixelCount;
	// __u32  *pu32SatHist; // removed pointer for unaligned sizeof behavior
	__u32  u32Noncolor;
};

// align with ST_PQ_YHSL_GETLUMAHIST_STATUS
struct v4l2_pq_yhsl_get_luma_hist_status {
	__u32 u32Version;
	__u32 u32Length;
	// __u32 *pu32YHist; // removed pointer for unaligned sizeof behavior
};

// aligh with struct ST_PQ_YHSL_GETLUMARPT_STATUS
struct v4l2_pq_yhsl_get_luma_rpt_status {
	__u32 u32Version;
	__u32 u32Length;
	__u8 u8MaxLuma;
	__u8 u8MinLuma;
	__u64 u64TotalPixelWeight;
	// __u32 *pu32YHist; // removed pointer for unaligned sizeof behavior
};

// align with struct ST_PQ_YHSL_GETLUMAAVG_STATUS
struct v4l2_pq_yhsl_get_luma_avg_status {
	__u32 u32Version;
	__u32 u32Length;
	__s32 s32Yavg;
};

// align with ST_PQ_HDRRPT_GETYHIST_STATUS
struct v4l2_pq_hdr_get_yhist_status {
	__u32 u32Version;
	__u32 u32Length;
	// __u32* pu32YHist; // removed pointer for unaligned sizeof behavior
};

// align with ST_PQ_HDRRPT_GETRPT_STATUS
struct v4l2_pq_hdr_get_rpt_status {
	__u32 u32Version;
	__u32 u32Length;
	// __u32* pu32YHist; // removed pointer for unaligned sizeof behavior
};

// align with m_pq_histogram_info
struct v4l2_pq_histogram_info {
	//--------------SET--------------//
	enum v4l2_pq_histogram_type eHistogramType;
	__u32 u32BinNum;
	//--------------GET--------------//
	struct v4l2_pq_histogram_bin_num BinRange;
	struct v4l2_pq_yhsl_get_hue_rpt_status HueRptStatus;
	struct v4l2_pq_yhsl_get_sat_rpt_status SatRptStatus;
	struct v4l2_pq_yhsl_get_luma_hist_status LumaHistStatus;
	struct v4l2_pq_yhsl_get_luma_rpt_status LumaRptStatus;
	struct v4l2_pq_yhsl_get_luma_avg_status LumaAvgStatus;
	struct v4l2_pq_hdr_get_yhist_status HDRYHistStatus;
	struct v4l2_pq_hdr_get_rpt_status HDRRptStatus;
	__u32 pu32Data[V4L2_HISTOGRAM_BIN_NUM_MAX];
};

enum v4l2_re_queue_event {
	V4L2_RE_QUEUE_NONE,
	V4L2_RE_QUEUE_THERMAL,
	V4L2_RE_QUEUE_INPUT,
	V4L2_RE_QUEUE_HDR_CHANGE, // hdr changes within a video
	V4L2_RE_QUEUE_MAX,
};
