...
E_GOP_API_Result MApi_GOP_TriggerAutoDetect(MS_U8 u8GOP)
{
	return GOP_TriggerAutoDetect(u8GOP);
}

E_GOP_API_Result MApi_GOP_SetOsdb_Dst(MS_U8 u8GOP, EN_GOP_OPDST eOpDstPos)
{
	return GOP_SetOsdb_Dst(u8GOP, eOpDstPos);
}

E_GOP_API_Result MApi_GOP_Set_osdb_loc(EN_GOP_OSDB_LOCATION eOsdbLoc)
{
	return GOP_SetOsdbLoc(eOsdbLoc);
}

E_GOP_API_Result MApi_GOP_SetOverScanInfo(MS_U8 u8GOP, MS_BOOL bOverScanEn)
{
	return GOP_SetOverScanInfo(pInstantGOP, u8GOP, bOverScanEn);
}

E_GOP_API_Result MApi_GOP_SetMixer4Size(MS_U32 u32Width, MS_U32 u32Height)
{
	return GOP_SetMixer4Size(u32Width, u32Height);
}

E_GOP_API_Result MApi_GOP_SetMixer2Size(MS_U32 u32Width, MS_U32 u32Height)
{
	return GOP_SetMixer2Size(u32Width, u32Height);
}

E_GOP_API_Result MApi_GOP_SetPanelSize(MS_U8 u8GOP, MS_U32 u32Width, MS_U32 u32Height)
{
	return GOP_SetPanelSize(pInstantGOP, u8GOP, u32Width, u32Height);
}
