...
/// GOP API return value
	typedef enum {
		...
		///GOP API menuload need retry.
		GOP_API_MENULOAD_RETRY,
...
/// GOP init info
	typedef struct DLL_PACKED {
		...
		///panel h-start.
		MS_U16 u16PanelHStr;
		/// Menu load fd for vg blending
		MS_U32 u32ML_Fd;
		/// Menu load fd for vg separate
		MS_U32 u32ML_FdVGSep;
	} GOP_InitInfo;
...
///GOP AFBC support info
	...
	typedef enum {
		E_GOP_PQGAMMA_OSDB_LD_PADJ,
		E_GOP_PQGAMMA_LD_OSDB_PADJ,
		E_GOP_OSDB_PQGAMMA_LD_PADJ,
		E_GOP_OSDB_LD_PQGAMMA_PADJ,
		E_GOP_LD_PQGAMMA_OSDB_PADJ,
		E_GOP_LD_OSDB_PQGAMMA_PADJ,
		E_GOP_LOCATION_MAX,
	} EN_GOP_OSDB_LOCATION;
...
DLL_PUBLIC SYMBOL_WEAK E_GOP_API_Result MApi_GOP_TriggerAutoDetect(MS_U8 u8GOP);
DLL_PUBLIC SYMBOL_WEAK E_GOP_API_Result MApi_GOP_SetOsdb_Dst(MS_U8 u8GOP, EN_GOP_OPDST eOpDstPos);
DLL_PUBLIC SYMBOL_WEAK E_GOP_API_Result MApi_GOP_Set_osdb_loc(EN_GOP_OSDB_LOCATION eOsdbLoc);
DLL_PUBLIC SYMBOL_WEAK E_GOP_API_Result MApi_GOP_SetOverScanInfo(MS_U8 u8GOP, MS_BOOL bOverScanEn);
DLL_PUBLIC SYMBOL_WEAK E_GOP_API_Result MApi_GOP_SetMixer4Size(MS_U32 u32Width, MS_U32 u32Height);
DLL_PUBLIC SYMBOL_WEAK E_GOP_API_Result MApi_GOP_SetMixer2Size(MS_U32 u32Width, MS_U32 u32Height);
DLL_PUBLIC SYMBOL_WEAK E_GOP_API_Result MApi_GOP_SetPanelSize(MS_U8 u8GOP,
