...
struct drm_prop_enum_list gop_blending_dst_enum_list[] = {
	{.type = MTK_DRM_DST_OSDB0, .name = MTK_PLANE_PROP_DST_OSDB0},
	{.type = MTK_DRM_DST_OSDB1, .name = MTK_PLANE_PROP_DST_OSDB1},
	{.type = MTK_DRM_DST_INVALID, .name = MTK_PLANE_PROP_DST_INVALID},
};

struct drm_prop_enum_list gop_csc_enum_list[] = {
	{.type = MTK_DRM_CSC_Y2R_709_F2F, .name = "Y2R_709_F2F"},
	{.type = MTK_DRM_CSC_Y2R_709_F2L, .name = "Y2R_709_F2L"},
	{.type = MTK_DRM_CSC_Y2R_709_L2F, .name = "Y2R_709_L2F"},
	{.type = MTK_DRM_CSC_Y2R_709_L2L, .name = "Y2R_709_L2L"},
	{.type = MTK_DRM_CSC_Y2R_601_F2F, .name = "Y2R_601_F2F"},
	{.type = MTK_DRM_CSC_Y2R_601_F2L, .name = "Y2R_601_F2L"},
	{.type = MTK_DRM_CSC_Y2R_601_L2F, .name = "Y2R_601_L2F"},
	{.type = MTK_DRM_CSC_Y2R_601_L2L, .name = "Y2R_601_L2L"},
	{.type = MTK_DRM_CSC_R2Y_709_F2F, .name = "R2Y_709_F2F"},
	{.type = MTK_DRM_CSC_R2Y_709_F2L, .name = "R2Y_709_L2F"},
	{.type = MTK_DRM_CSC_R2Y_709_L2F, .name = "R2Y_709_F2L"},
	{.type = MTK_DRM_CSC_R2Y_709_L2L, .name = "R2Y_709_L2L"},
	{.type = MTK_DRM_CSC_R2Y_601_F2F, .name = "R2Y_601_F2F"},
	{.type = MTK_DRM_CSC_R2Y_601_F2L, .name = "R2Y_601_L2F"},
	{.type = MTK_DRM_CSC_R2Y_601_L2F, .name = "R2Y_601_F2L"},
	{.type = MTK_DRM_CSC_R2Y_601_L2L, .name = "R2Y_601_L2L"},
	{.type = MTK_DRM_CSC_NONE, .name = "CSC_NONE"},
};
...
static const struct ext_prop_info gop_plane_props[] = {
	...
	{
		.prop_name = MTK_GOP_PLANE_PROP_BLENDING_DST,
		.flag = DRM_MODE_PROP_ENUM | DRM_MODE_PROP_ATOMIC,
		.enum_info.enum_list = &gop_blending_dst_enum_list[0],
		.enum_info.enum_length = ARRAY_SIZE(gop_blending_dst_enum_list),
	},
	{
		.prop_name = MTK_GOP_PLANE_PROP_CSC,
		.flag = DRM_MODE_PROP_ENUM | DRM_MODE_PROP_ATOMIC,
		.enum_info.enum_list = &gop_csc_enum_list[0],
		.enum_info.enum_length = ARRAY_SIZE(gop_csc_enum_list),
	},
};
