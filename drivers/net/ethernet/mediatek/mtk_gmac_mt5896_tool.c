...
static void _mtk_dtv_gmac_cts_rgmii_cellmode(struct net_device *ndev)
{
	...
	//wriu     0x380756             0x00
	//wriu     0x380757             0x00
	mtk_writel(BANK_BASE_MAC_0 + GMAC0_REG_0150_X32_GMAC0, 0xa55a5aa5);
