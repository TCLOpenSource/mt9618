...
//	if ((pRes->sDMD_DTMB_PriData.m6_version & 0xFF0F) > MT5896_IP_VER) {
	temp1 = readl(pRes->sDMD_DTMB_PriData.virt_clk_base_addr + 0x14F0);// & 0xFFFFE0FF;
	temp1 |= 0x00001F00;
	writel(temp1, (pRes->sDMD_DTMB_PriData.virt_clk_base_addr + 0x14F0));
//	}
	...
	HAL_INTERN_DTMB_DBINFO(PRINT("DMDIP-Ver=0x%x\n", pRes->sDMD_DTMB_PriData.m6_version));
	if (pRes->sDMD_DTMB_PriData.m6_version == MT5896_IP_VER) {
		HAL_INTERN_DTMB_DBINFO(PRINT("------DMD_DTMB_CHIP_MT5896-E1E2-----\n"));
		...
		HAL_INTERN_DTMB_DBINFO(PRINT("---DMD_DTMB_CHIP_MT5897---MT5896E3---\n"));
