...
#ifndef _DEMOD_DRV_VIF_H_
#define _DEMOD_DRV_VIF_H_
...
extern u8 drv_vif_init(struct vif_initial_in *pvif_init_data,
	u32 init_data_len);
//-----------------------------------------------
/// VIF Software Reset
/// @ingroup VIF_Basic
...
/// @return FALSE :  fail
//-----------------------------------------------
extern bool drv_vif_set_filter_coef(void);
extern void drv_vif_coef_mapping(const struct firmware *fw);
extern s32 drv_vif_foe2hz(u8 foe, int tuner_quarter_step);
extern u8 drv_vif_read_statics(u8 *agc_num);
extern u8 drv_vif_get_information(struct dvb_frontend *fe,
	struct dtv_frontend_properties *p);
extern ssize_t drv_vif_fetch_information(char *buf);
