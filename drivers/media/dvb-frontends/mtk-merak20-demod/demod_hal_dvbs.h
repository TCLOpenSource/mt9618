...
#define ISDBTOUTER_REG_BASE                    0x1700
#define _REG_ISDBTOUTER(idx)                   (ISDBTOUTER_REG_BASE + (idx)*2)

#define   ISDBTOUTER_BITERR_PCKTPRD_ACC_EN       (_REG_ISDBTOUTER(0x01)+0)   //[1]
#define   ISDBTOUTER_BITERR_TIMEPRD_ACC_EN       (_REG_ISDBTOUTER(0x01)+0)   //[2]
#define   ISDBTOUTER_BITERR_NUM_PCKTPRD_FREEZE   (_REG_ISDBTOUTER(0x01)+1)   //[8]
#define   ISDBTOUTER_BITERR_NUM_TIMEPRD_FREEZE   (_REG_ISDBTOUTER(0x01)+1)   //[9]
#define   ISDBTOUTER_LOOP_NUM                         (_REG_ISDBTOUTER(0x02)+0)   //[2:0]
#define   ISDBTOUTER_BITERR_ADD                         (_REG_ISDBTOUTER(0x02)+1)   //[12:8]
#define   ISDBTOUTER_UNCRT_PKT_NUM_THRESHOLD     (_REG_ISDBTOUTER(0x04)+0)   //[15:0]
#define   ISDBTOUTER_BITERR_PCKTPRD_L              (_REG_ISDBTOUTER(0x05)+0)   //[7:0]
#define   ISDBTOUTER_BITERR_PCKTPRD_H              (_REG_ISDBTOUTER(0x05)+1)   //[15:8]
#define   ISDBTOUTER_BITERR_TIMEPRD              (_REG_ISDBTOUTER(0x06)+0)   //[31:0]
#define   ISDBTOUTER_TBVA_BYPASS                     (_REG_ISDBTOUTER(0x10)+0)   //[0]
#define   ISDBTOUTER_TBVA_TERMINATE_THD                     (_REG_ISDBTOUTER(0x10)+1)   //[15:8]
#define   ISDBTOUTER_BITERR_NUM_PCKTPRD          (_REG_ISDBTOUTER(0x13)+0)   //[31:0]
#define   ISDBTOUTER_BITERR_NUM_TIMEPRD          (_REG_ISDBTOUTER(0x15)+0)   //[31:0]
#define   ISDBTOUTER_UNCRT_PKT_NUM_PCKTPRD_7_0       (_REG_ISDBTOUTER(0x17)+0)   //[15:0]
#define   ISDBTOUTER_UNCRT_PKT_NUM_PCKTPRD_15_8       (_REG_ISDBTOUTER(0x17)+1)   //[15:0]
#define   ISDBTOUTER_UNCRT_PKT_NUM_TIMEPRD       (_REG_ISDBTOUTER(0x18)+0)   //[15:0]



#define REG_CKG_MCU_DMD_DEMOD0_OFFSET 0x3110
#define REG_CKG_MCU_BUS_DEMOD0_OFFSET 0x31C0
#define REG_SW_EN_MCU_BUS2DEMOD0_L_OFFSET 0x3B4C
#define REG_SW_EN_MCU_DMD2DEMOD0_OFFSET 0x3B5C
...
#define rolloff_flag    120
#define half_TP_SR   200
#define CNR_unit 256
...
#define half_blindscan_tuner_cutoff 22000
#define half_blindscan_unicable_cutoff 15000
#define force_cfo_small  -1000
#define force_cfo_large  -2000
#define force_cfo_criterion 15000
...
#define DVBS_BER_unit     10000000
#define BER_unit     1000000000
...
int intern_dvbs_BlindScan_iq_swap_check(
	struct DMD_DVBS_BlindScan_WaitCurFreqFinished_param *WaitCurFreqFinished_param);
void intern_dvbs_BlindScan_iq_swap_check_direct(u16 u16WaitCount, s32 freq_offset, bool *iq_swap);
void intern_dvbs_BlindScan_iq_swap_check_unicable(u16 u16WaitCount, s32 freq_offset, bool *iq_swap);
