 ...
 */
#ifndef	_DEMOD_DRV_ATSC_H_
#define	_DEMOD_DRV_ATSC_H_
...
//--------------------------------------------------
 ...
 #define	DVB_STI	 1
#endif
#define ATSC3_ALP_PREPARSE_EN				1
...
#define DMD_ATSC_LOCK_PRE_LOCK                  BIT_(0)
#define DMD_ATSC_LOCK_FSYNC_LOCK                BIT_(1)
#define DMD_ATSC_LOCK_CE_LOCK                   BIT_(2)
#define DMD_ATSC_LOCK_FEC_LOCK                  BIT_(3)
...
enum DMD_ATSC_HAL_COMMAND {
	...
	DMD_ATSC_HAL_CMD_SetOFDMMode,
	DMD_ATSC_HAL_CMD_SetEASMode,
	...
	DMD_ATSC_HAL_CMD_CheckType,
	DMD_ATSC_HAL_CMD_AGCLOCK,
	DMD_ATSC_HAL_CMD_PreLock,
	DMD_ATSC_HAL_CMD_FSync_Lock,
	DMD_ATSC_HAL_CMD_CE_Lock,
	DMD_ATSC_HAL_CMD_FEC_Lock,
	DMD_ATSC_HAL_CMD_EAS_Lock,
...
enum DMD_ATSC_GETLOCK_TYPE {
	DMD_ATSC_GETLOCK,
	DMD_ATSC_GETLOCK_AGCLOCK,
	DMD_ATSC_GETLOCK_PRELOCK,
	DMD_ATSC_GETLOCK_FSYNCLOCK,
	DMD_ATSC_GETLOCK_CELOCK,
	DMD_ATSC_GETLOCK_FECLOCK,
	DMD_ATSC_GETLOCK_EASLOCK,
...
struct DLL_PACKED DMD_ATSC_INITDATA {
	...
	u16 u16OFDMAGCLockCheckTime;//100
	u16 u16OFDMPreLockCheckTime;//300
	u16 u16OFDMFSyncLockCheckTime;//120
	u16 u16OFDMFECLockCheckTime;//5000
	...
	//By SYS EAS mode setting (Only for ATSC3 EAS):
	u8 u8EASMode;

	//BY PLP (Only for ATSC3)
	u8 u8PLP_num;
	u8 u8PLP_id[4];
	u8 u8PLP_layer[4];
	u8 u8Minor_Version;
...
DLL_PUBLIC extern ssize_t atsc_get_information(
char *buf);
DLL_PUBLIC extern u8 _mdrv_dmd_atsc3_md_get_info(struct dvb_frontend *fe,
struct dtv_frontend_properties *p);
#endif //	#ifdef UTPA2
