...
// 10: Add Dolby support check
// 11: Refine SVP create pipeline flow and pr_ctrl condition
// 12: Add PR capability and turnoff control flow
// 13: Add SYSFS force L1L4 gen command
#define DV_PQ_VERSION (13)
