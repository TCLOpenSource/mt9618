...
#include "hwreg_pq_display_znr.h"
...
#define MCDI_BUFFER_SIZE0		0x010000
#define MCDI_BUFFER_SIZE1		0x100000
#define DIPDI_BUFFER_SIZE		0xFD2000
#define DIPDI_FRAME		4
#define DV_CONFIG_BIN_OFFSET		(0x2000)
...
#define MMAP_CFD_BUF_INDEX          10
#define MMAP_DDBUF_MAX              11
#define MMAP_UCD_INDEX              0

#define ZNR_BLK_SIZE_CH_0    32
#define ZNR_BLK_SIZE_CH_1    16
