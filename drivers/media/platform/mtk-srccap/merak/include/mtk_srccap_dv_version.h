...
// 7: Add reqbufs flow
// 8: Add DV support check and debug mode force_disable_dolby and force_game_mode
#define SRCCAP_DV_VERSION (8)
...
//12: Refine IRQ info and fix NEG freeze issue
#define SRCCAP_DV_DESCRB_VERSION (12)
...
// 8: add sw mode implementation
// 9: Refine IRQ info
//10: Refine dqbuf flow for legacy mode
//11: Add reqbufs flow for set frame number
#define SRCCAP_DV_DMA_VERSION (11)
