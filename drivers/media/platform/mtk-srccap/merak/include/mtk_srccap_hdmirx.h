...
/* ============================================================================================== */
#define MAX_INT_N 12
#define SPD_PKT_HEAD (0x1A)
#define VFREQX1000 1000
#define FREESYNC_MULTIPLE 2400
...
#define HDMI_META_COLOR_DEPTH          "ColorDepth"
#define HDMI_META_GC_AVMUTE            "GcAvmute"
#define HDMI_META_AVI_CONTENT_TYPE     "ContentType"
#define HDMI_META_AVI_COLOR_FORFAT     "ColorFormat"
#define HDMI_META_AVI_COLOR_RANGE      "ColorRange"
#define HDMI_META_AVI_AFD              "Afd"
#define HDMI_META_AVI_SCAN_INFO        "ScanInfo"
#define HDMI_META_AVI_COLORIMETRY      "Colorimetry"
#define HDMI_META_AVI_EXT_COLORIMETRY  "ExtColorimetry"
#define HDMI_META_AVI_PIC_AR           "PicAr"
#define HDMI_META_IMAX_MODE            "ImaxMode"
#define HDMI_META_HDMI_MODE            "HdmiMode"
#define HDMI_META_ALLM_MODE            "AllmMode"
...
typedef enum {
	E_HDMI_BCH_ERROR_CORRECTED = BIT(0),
	E_HDMI_BCH_ERROR = BIT(1),
	E_HDMI_CHECKSUM_ERROR = BIT(2),
	E_HDMI_PHY_STATE_NOT_READY = BIT(3),
	E_HDMI_REGEN_NOT_DONE = BIT(4),
	E_HDMI_UNSUPPORT_PACKET = BIT(5),
} E_HDMI_BCH_ERROR_TYPE;
...
struct srccap_hdmirx_info {
	...
	struct task_struct *ctrl_hdmi_status_monitor_task;
	...
	unsigned char u8ALLMMode[HDMI_PORT_MAX_NUM];
	unsigned int u32NoHFVSIFCnt[HDMI_PORT_MAX_NUM];
	bool bNoHFVSIF[HDMI_PORT_MAX_NUM];
	...
	unsigned int u32MonitorEvent;
	bool bDEStatus[HDMI_PORT_MAX_NUM];
	bool bClkStatus[HDMI_PORT_MAX_NUM];
	bool bHDMIStatus[HDMI_PORT_MAX_NUM];
	bool bStable[HDMI_PORT_MAX_NUM];
	unsigned int u32HDE[HDMI_PORT_MAX_NUM];
	unsigned int u32VDE[HDMI_PORT_MAX_NUM];

};

struct srccap_hdmirx_metainfo {
	__u8 eHdmiColorDepth;
	__u8 u8HdmiAvmute;
	__u8 eContentType;
	//enum m_hdmi_color_format eHdmiColorformat;
	enum m_hdmi_color_range eHdmiColorRange;
	enum m_hdmi_ar_type eHdmiAfd;
	__u8 eScanInfo;
	enum m_hdmi_colorimetry_format eColorimetry;
	enum m_hdmi_colorimetry_format eExtColorimetry;
	__u8 ePicAr;
	//__u8 bImaxMode;
	bool bHdmiMode;
	unsigned char u8Allm;
};
...
extern enum v4l2_srccap_input_source
	mtk_hdmirx_search_hardware_port_num(int u8PortIndex);

extern enum srccap_input_port
...
extern bool mtk_srccap_hdmirx_get_ClkStatus(
	enum v4l2_srccap_input_source src
	);
...
extern enum m_freesync_type mtk_srccap_hdmirx_pkt_get_freesync_type(
	enum v4l2_srccap_input_source src,
	bool NativeColorActive,
	int FpsMultiple
	);

extern int mtk_srccap_hdmirx_get_pixel_freq(
	enum v4l2_srccap_input_source src
	);

extern bool mtk_srccap_hdmirx_set_scdcval(
	E_MUX_INPUTPORT enInputPortType,
	MS_U8 u8Offset, MS_U8 u8SCDCValue);

extern bool mtk_srccap_hdmirx_ddc_bus_control(
	MS_BOOL bEnable,
	E_MUX_INPUTPORT enInputPortType);

extern bool mtk_srccap_hdmirx_get_event_change(
	struct mtk_srccap_dev *srccap_dev);
...
// pkt
extern int mtk_srccap_hdmirx_pkt_get_spd(
	enum v4l2_srccap_input_source src,
	u8 u8DevId,
	struct meta_srccap_spd_pkt *ptr);
