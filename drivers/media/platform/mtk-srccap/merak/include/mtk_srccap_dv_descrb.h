...
struct srccap_dv_descrb_irq_info {
	uint8_t *data;
...
struct srccap_dv_descrb_buf {
	struct srccap_dv_descrb_irq_info irq_info[SRCCAP_DV_DESCRB_BUF_NUM];
	uint8_t irq_wptr;
	uint8_t irq_rptr;
	/* NEG control */
