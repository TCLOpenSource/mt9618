...
#define SRCCAP_DV_REG_NUM (10)

//-----------------------------------------------------------------------------
// Enums and Structures
//-----------------------------------------------------------------------------

struct srccap_dv_debug_mode {
	enum srccap_dv_debug_force_game_mode force_game_mode;
};
...
struct srccap_dv_info {
	...
	struct srccap_dv_debug_mode debug_mode;
...
enum srccap_dv_dqbuf_mode {
	SRCCAP_DV_DQBUF_MODE_ORIGINAL = 0,
	SRCCAP_DV_DQBUF_MODE_FROM_DQBUF,
	SRCCAP_DV_DQBUF_MODE_FROM_IRQ,
	SRCCAP_DV_DQBUF_MODE_NUM,
};
