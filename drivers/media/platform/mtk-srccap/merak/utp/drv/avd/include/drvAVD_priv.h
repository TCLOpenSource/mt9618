...
extern MS_BOOL Drv_AVD_ResetDSP(struct AVD_RESOURCE_PRIVATE *pResource);
...
extern void Drv_AVD_Set_75IRE_Setup_Cancel(MS_BOOL bEnable,
		struct AVD_RESOURCE_PRIVATE *pResource);
...
extern void Drv_AVD_GetFactoryPara(enum AVD_Factory_Para FactoryPara, MS_U8 *u8Value,
		struct AVD_RESOURCE_PRIVATE *pResource);
