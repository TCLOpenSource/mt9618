...
#define STI_LOGI(tag, fmt, ...)      pr_err("[SRCCAP][" tag "]: " fmt, ##__VA_ARGS__)
...
/// @return FALSE : fail
//-------------------------------------------------------------------------------------------------
extern MS_BOOL Api_AVD_DspReset(void);
//-------------------------------------------------------------------------------------------------
////////////////////////////////////////////////////////////////////////////////
...
//-------------------------------------------------------------------------------------------------
/// Set 7.5 IRE Setup Cancel
/// @ingroup AFEC relative
/// @param  bEnable   \b IN: set 7.5 IRE Setup Cancel.
//-------------------------------------------------------------------------------------------------
extern void Api_AVD_75IRE_Setup_Cancel(MS_BOOL bEnable);
...
//-------------------------------------------------------------------------------------------------
/// Get AVD factory parameters
/// @ingroup Get_VD_Info
/// @param  FactoryPara   \b IN: factory parameters/register
/// @param  u8Value   \b IN: getting value
//-------------------------------------------------------------------------------------------------
extern void Api_AVD_GetFactoryPara(enum AVD_Factory_Para FactoryPara, MS_U8 *u8Value);
