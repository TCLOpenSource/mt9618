...
void HAL_NJPD_SetPitch(__u16 u16Value)
{
	NJPD_DEBUG_HAL_MSG("%s : 0x%04x\n", __func__, u16Value);
	reg16_write(BK_NJPD_PITCH_WIDTH, u16Value);
	NJPD_DEBUG_HAL_MSG("HAL_NJPD_GetPitch : 0x%04x\n", reg16_read(BK_NJPD_PITCH_WIDTH));
}
