...
void MDrv_NJPD_SetPitch(__u16 u16PicWidth)
{
	HAL_NJPD_Set_GlobalSetting02(HAL_NJPD_Get_GlobalSetting02() | NJPD_PITCH_EN);
	HAL_NJPD_SetPitch(u16PicWidth >> E_NUM3);
	NJPD_DEBUG_DRV_MSG("set pitch:%u\n", u16PicWidth);
}
