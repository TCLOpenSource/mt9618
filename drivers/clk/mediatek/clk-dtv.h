...
enum dtv_regbank_type {
	CLK_PM,
	CLK_NONPM,
	CLK_BANK_TYPE_MAX,
};

typedef int (*mtkdtv_clock_write)(enum dtv_regbank_type bank_type, unsigned int reg_addr,
		u16 value, unsigned int start, unsigned int end);

typedef int (*mtkdtv_clock_read)(enum dtv_regbank_type bank_type, unsigned int reg_addr,
